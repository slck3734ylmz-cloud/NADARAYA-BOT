...
st.markdown(
    """
    <style>
    /* Yenileme esnasında ekranın kararmasını (dimming efekti) kesin olarak engeller */
...
# ================= MOD 2: CANLI DCA TERMINAL MODU =================
    ...
    # MİMARİ GÜNCELLEME: Döngüsüz, kararmasız ve kilitlenmesiz kararlı yapıya geçildi (while True kaldırıldı)
    try:
    ...
    # ================= GERİ SAYIM SAYACI VE YENİDEN TETİKLEME (Döngüsüz, kararmasız rerun yapısı) =================
    # HATA GİDERİCİ: 'live_plotly_1m_uq' key hatası st.rerun öncesinde tüm grafikler sıfırlanarak ve tekil akışla kesin olarak çözüldü.
